	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="#">Home</a></li>
				<li class='active'>Harvinet Cart</li>
			</ul>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Order Information</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Your Location  <span>*</span></label>
